...
class btGjkEpaPenetrationDepthSolver : public ConvexPenetrationDepthSolver
{
public:
	/*virtual */bool ComputePenetrationDepth (const rage::phBound* convexA, const rage::phBound* convexB, rage::Mat34V_In transA, rage::Mat34V_In transB,

...
//#include <stdio.h>
#if 0
btSphereBoxCollisionAlgorithm::btSphereBoxCollisionAlgorithm(rage::phManifold* mf,const btCollisionAlgorithmConstructionInfo& ci,btBroadphaseProxy* proxy0,btBroadphaseProxy* proxy1)
...
void btSphereBoxCollisionAlgorithm::DetectCollision (const rage::phCollisionInput& input, rage::Vector3::Param offsetA, rage::phManifold& manifold, DiscreteCollisionDetectorInterface::Result& manifoldResult)
{

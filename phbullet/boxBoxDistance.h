...
ScalarV_Out
boxBoxDistance(Vec3V_InOut normal, Vec3V_InOut boxPointA, Vec3V_InOut boxPointB,
			   Vec3V_In boxA, Mat34V_In transformA, Vec3V_In boxB,
			   Mat34V_In transformB,
			   ScalarV_In distanceThreshold = ScalarV(V_FLT_MAX) );

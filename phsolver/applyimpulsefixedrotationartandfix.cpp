// 
// phsolver/applyimpulsefixedrotationartandfix.cpp 
// 
...
void ApplyImpulseFixedRotationArtAndFix(phManifold& manifold, const phForceSolverGlobals& globals)
{
	...
	Vec3V angVelA = CALL_MEMBER_FN(*bodyA, GetAngularVelocity)(link);
	...
	CALL_MEMBER_FN(*bodyA, ApplyAngImpulse)(link, angImpulse.GetIntrin128());
}

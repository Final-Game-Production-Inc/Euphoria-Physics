...
namespace ART
{
  ...
  public:
    ...
    inline void setAvoidLeg(bool avoidLeg) { m_roPacket.m_avoidLeg = avoidLeg; }
    inline void setAvoidFootWidth(float avoidFootWidth) { m_roPacket.m_avoidFootWidth = avoidFootWidth; }
    inline void setAvoidFeedback(float avoidFeedback) { m_roPacket.m_avoidFeedback = avoidFeedback; }
    ...
    inline void setDontStepTime(float time){ m_dontStepTime = time; }
    ...
    inline void forceFail(){ forceFailOnly(); deactivate(); }
    ...
    inline bool getFailMustCollide(){ return m_failMustCollide; }
    ...
    inline void setBackwardsLeanCutoff(float val) { m_backwardsLeanCutoff = val; }

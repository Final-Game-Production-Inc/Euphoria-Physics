...
namespace ART
{
  ...
  public:
    ...
    struct Parameters
    {
      ...
      bool m_onFire;
      float m_shoulderLean1;
      float m_shoulderLean2;
      float m_lean1BlendFactor;
      float m_lean2BlendFactor;
      float m_rollTorqueScale;
      float m_maxRollOverTime;
      float m_rollOverRadius;
  ...
  protected:
    ...
    float           m_onFireRollOverTimer;
    bool            m_bodyOnGround;
    bool            m_bodyHitGround;
  };
}

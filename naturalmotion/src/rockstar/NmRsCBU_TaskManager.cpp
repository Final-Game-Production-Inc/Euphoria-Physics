...
namespace ART
{
  ...
  void NmRsCBUTaskManager::init(ART::AgentID id, NmRsCharacter* character)
  {
    ...
    if (character->isBiped())
    {
      ...
      NM_RS_CBU_CREATE(onFire,               NmRsCBUOnFire);
      ...
      NM_RS_CBU_CREATE(smartFall,             NmRsCBUSmartFall);
  ...
  void NmRsCBUTaskManager::term(ART::AgentID id)
  {
    ...
    NM_RS_CBU_DELETE(onFire,                NmRsCBUOnFire);
    ...
    NM_RS_CBU_DELETE(smartFall,             NmRsCBUSmartFall);

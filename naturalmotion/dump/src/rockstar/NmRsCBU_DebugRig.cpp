...
namespace ART
{
  ...
  void NmRsCBUDebugRig::onActivate()
  {
    ...
    m_character->constrainPart(m_bodyPartConstraint, head->getPartIndex(), 0, 0.0f , m_attachmentPos,m_attachmentPos, -1, true, true, NM_MIN_STABLE_DISTANCECONSTRAINT_DISTANCE);

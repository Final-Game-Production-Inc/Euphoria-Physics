...
//      profiler->endSection();
	  ...
	  // Desired leans are getting Nans on rare occasion
	  Assert(body.m_leftHip.m_desiredLean1==body.m_leftHip.m_desiredLean1);
	  Assert(body.m_leftHip.m_desiredLean2==body.m_leftHip.m_desiredLean2);
	  Assert(body.m_rightHip.m_desiredLean1==body.m_rightHip.m_desiredLean1);
	  Assert(body.m_rightHip.m_desiredLean2==body.m_rightHip.m_desiredLean2);
	  if (body.m_leftHip.m_desiredLean1 != body.m_leftHip.m_desiredLean1 || body.m_leftHip.m_desiredLean2 != body.m_leftHip.m_desiredLean2 ||
		  body.m_rightHip.m_desiredLean1 != body.m_rightHip.m_desiredLean1 || body.m_rightHip.m_desiredLean2 != body.m_rightHip.m_desiredLean2)
	  {
		  body.m_leftHip.m_desiredLean1 = body.m_leftHip.m_desiredLean2 = body.m_rightHip.m_desiredLean1 = body.m_rightHip.m_desiredLean2 = 0.0f;
	  }

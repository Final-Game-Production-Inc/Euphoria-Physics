...
#define NMGrabDropRightWeaponFeedbackName  "grabDropRightWeapon"
  ...
  protected:
    ...
    void decideToGrab(bool &moveLeft, bool &moveRight);
    void decideToGrabFromParameters(bool &moveLeft, bool &moveRight);

    void moveArm(rage::Vector3 &armTarget, rage::Vector3 &armNormal, BehaviourMask effectorMask, rage::phConstraintHandle &constraint, NmRsHumanArm *limb, NmRsLimbInput& input, int direction, bool &isConstrained, float &holdTimer, float &localPullUpStrength, bool useHardConstraint = true);

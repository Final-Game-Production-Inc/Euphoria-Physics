...
#define NMShotImpulseDebug
  ...
  protected:
    ...
    struct ArmProperty
    {
      // limbs todo figure out what the intention is here. clearly this doesn't need
      // to be a struct...
      NmRsHumanArm *arm;
    ...
    float m_reactionTime;//chicken and fling reaction time

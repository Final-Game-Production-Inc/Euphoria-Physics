...
namespace ART
{
     #define BulletBSpyDraw 0
    #define BulletBSpyScratchPad 0
    ...
    public:  
      ...
      void newHit(int partID, const rage::Vector3 &imp, const rage::Vector3 &position, float equalizer = 0.0f); 
    ...
    protected:
	  ...
	  float downwardSlopeAt(float x, float base);

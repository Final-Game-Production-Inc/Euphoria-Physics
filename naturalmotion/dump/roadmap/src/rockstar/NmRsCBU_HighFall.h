...
#undef HF_ENUM_ACTION
  ...
  #define HF_ORIENTATION_STATES(_action) \
    _action(HFO_Up) \
    _action(HFO_Down) \
    _action(HFO_Front) \
    _action(HFO_Back) \
    ...
    {
#define HF_ENUM_ACTION(_name) _name,
      HF_ORIENTATION_STATES(HF_ENUM_ACTION)
#undef HF_ENUM_ACTION
    };
  ...
  protected:
    ...
    OrientationStates getFacingDirectionFromCOMOrientation(const rage::Matrix34 &COMOrient) const;
    ...
    OrientationStates m_orientationState;
    OrientationStates m_orientationStateTimeHalved;
    OrientationStates m_orientationStateCurrent;

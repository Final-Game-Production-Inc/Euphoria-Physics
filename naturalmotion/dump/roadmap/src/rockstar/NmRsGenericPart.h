...
#define getPartMass(part) ((part).GetMass().Getf())
  ...
  public:
     ...
     */
    void applyVelocitiesToPart(const NMutils::NMMatrix4& fromTm, const NMutils::NMMatrix4& toTm, float invDeltaTime);

    /**
     * return a valid matrix for the part's present location.
     */
    void getMatrix(NMutils::NMMatrix4 mtm) const;
     ...
     * 
     */
    void setMatrix(const NMutils::NMMatrix4 &matrix, bool initial = false);
    void setMatrix(const rage::Matrix34 &rageMatrix, bool initial = false);

    /**
     * this is like setMatrix but the old matrix is updated too.
     */
    void teleportMatrix(const NMutils::NMMatrix4 &matrix, bool initial = false);

    /**
     * Return position of this part.
     */
    void getPosition(NMutils::NMVector3 pos) const;
    ...
    /**
     * Return angular velocity for this part.
     */
    void getAngularVelocity(NMutils::NMVector3 angVelocity) const;
     ...
     */
    void applyImpulse(const NMutils::NMVector3 impulse, const NMutils::NMVector3 position);

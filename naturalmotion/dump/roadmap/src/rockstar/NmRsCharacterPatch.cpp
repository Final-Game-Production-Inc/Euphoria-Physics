        ...
        if (pInst)
        {
          ...
          if (pBound)
          {
            ...
            if (pBound)
            {
              ...
              DynamicCollisionShapePacket dcs((bs_uint32)m_patches[i].instLevelIndex, (bs_uint32) pBound, (bs_int16) getBSpyID(), (bs_int32)pInst->GetClassType());

...
NM_RS_PARAMETER_DIRECT(NmRs1DofEffector, float, MuscleStiffnessScaling, 1.0f, 10.0f, 0.0f)
NM_RS_PARAMETER_DIRECT(NmRs1DofEffector, float, MuscleStrengthScaling, 1.0f, 10.0f, 0.0f)
NM_RS_PARAMETER_DIRECT(NmRs1DofEffector, float, MuscleDampingScaling, 1.0f, 10.0f, 0.0f)
